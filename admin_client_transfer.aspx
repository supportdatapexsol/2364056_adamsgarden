        ...
        <div class="row">
            ...
            <div class="clear"></div>
                   ...
                   <div id="r1"  style="float:right;width:30%;" >
                       ...
                       <asp:Image ID="sellerimg" runat="server" style="width:155px;height:155px" />
...
-->
                        ...
                        <div id="result" style="float:right;width:30%">
                            <asp:Image ID="buyerimage" runat="server" style="width:155px;height:155px" />
                            </div>
                        <asp:Label ID="lbnameid" runat="server" Text="Mr/Mrs/Miss : " for="lbbuyername"></asp:Label>
                        <asp:Label ID="lbbuyername" runat="server" Text="" Font-Bold="true" Font-Size="Large"></asp:Label>
                        <br /><br />
