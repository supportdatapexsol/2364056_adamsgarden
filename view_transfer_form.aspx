<%@ Page Title="" Language="C#" MasterPageFile="~/sitedashboardmaster.master" AutoEventWireup="true" CodeFile="view_transfer_form.aspx.cs" Inherits="view_transfer_form" %>
                        ...
                        ImageUrl="Images/logo.jpg" Width="50%" style="float:left;width:200px;height:100px; margin-top: 8px;"/>
                           ...
                           <div  class="col-sm-8">
                            ...
                            <div style="float:left;width:100%;text-align:center; " >
                                ...
                                <% int id = int.Parse(Session["tbid"].ToString());
                                    
                                    DataTable database = viewtranfserform.gettingbuyerinfo(id);
        DataRow seller = database.Rows[0];
        DataRow buyer = database.Rows[1];
 %>
                        
                     <div  style="text-align:justify;float:left;width:60%; margin-left: 40px;">
                   <% string regno = seller["regno"].ToString(); %>
                                        <br />
                   ...
                   <div id="r1"  style="float:right;width:30%;" >
                       ...
                       <img id="Imge" src='data:image/jpg;base64,<%=seller["image"] != System.DBNull.Value ? Convert.ToBase64String((byte[])seller["image"]) : string.Empty %>'  style="width:155px;height:155px"/>
...
-->
                        ...
                        <div id="result" style="float:right;width:30%">
                            ...
                            <img id="Imge1" src='data:image/jpg;base64,<%=buyer["image"] != System.DBNull.Value ? Convert.ToBase64String((byte[])buyer["image"]) : string.Empty %>'  style="width:155px;height:155px"/>
                            </div>
                        <asp:Label ID="lbnameid" runat="server" Text="Mr/Mrs/Miss : " for="lbbuyername"></asp:Label>
                         <label id="lbbuyername"><%=buyer["name"].ToString()%></label>
                        <br /><br />
                         <asp:Label ID="lbnic" runat="server" Text="NIC No. : " for="lbbuyernic"></asp:Label>
                         <label id="lbbuyernic"><%=buyer["applicant_cnic"].ToString()%></label>

                        <br /><br />
                <asp:Label ID="lbresidenceid" runat="server" Text="Residence of : " for="lbbuyeraddress"></asp:Label>
                                                 <label id="lbbuyeraddress"><%=buyer["present_address"].ToString()%></label>
